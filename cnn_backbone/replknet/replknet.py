...
class RepLKNet(nn.Module):
    ...
    def __init__(self, large_kernel_sizes, layers, channels, drop_path_rate, small_kernel,
                 dw_ratio=1, ffn_ratio=4, in_channels=3, num_classes=1000, out_indices=[0,1,2,3],
    ...
    def forward_features(self, x):
        ...
        for stage_idx in range(self.num_stages):
            ...
            if stage_idx < self.num_stages - 1:
                x = self.transitions[stage_idx](x)          # 三次 transitions
        return outs
...
build_RepLKNet_model = {
    "RepLKNet31B" : create_RepLKNet31B,
    "RepLKNet31L" : create_RepLKNet31L,
    "RepLKNetXL" : create_RepLKNetXL
}
